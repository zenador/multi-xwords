...
function oyCrosswordClue(
	...
	answer,		// the word itself, i.e. "Abstract"; maybe be ommited, thus disabling the "Reveal" function
	...
	clue2,		// the text of the 2nd word clue given to the user
	synset		// the synset id in wordnet
){
	this.len = len;
	this.clue = clue;
	this.answer = answer;
...
oyClueList.prototype.render = function(){
	...
	for (var i=0; i < this.clues.length; i++){	
		...
		buf += "<tr><td class='oyListNormal' id='" + this.ns + i + "'><a onClick='oygCrosswordPuzzle.footer.stateOk(\"Alternative clue: " + this.clues[i].clue2 + "\");'><b>" + (i + 1) + ".</b></a> " + this.clues[i].clue + "</td></tr>";		
	}	  
	buf += "</table>";
